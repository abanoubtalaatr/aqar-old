...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'Al3aqr Messenger'),
    ...
    */
    'routes' => [
        ...
        'prefix' => env('CHATIFY_ROUTES_PREFIX', 'dashboard/chatify'),
        'middleware' => env('CHATIFY_ROUTES_MIDDLEWARE', ['web','auth','LanguageManager']),
    ...
    */
    'user_avatar' => [
        'folder' => 'avatars', // Folder for stored avatars
        'default' => 'admin/dist/img/avatar.png', // Default avatar path
    ],
