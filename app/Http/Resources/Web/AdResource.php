...
class AdResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        if (auth('api')->user() == null) {
            ...
            $raters_number = Rate::where('user_id', $this->user_id)->pluck('rate')->count() ?? null;
        } else {
        ...
        return [
            ...
            'advertiser_relationship_with_property' => $this->advertiser_relationship_with_property_val,
