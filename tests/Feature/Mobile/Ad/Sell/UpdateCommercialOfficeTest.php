...
class UpdateCommercialOfficeTest extends TestCase
{
    use RefreshDatabase;
    /** @test */
    /** @test */
    public function it_updates_a_commercial_office_ad_successfully()
    {
        // Create a user and log them in
        $user = User::factory()->create();
        $token = auth('api')->login($user);

        // Create a category for "Commercial"
        $category = Category::factory()->create([
            'id' => 10,
            'adable' => "App\Models\CommercialOffice",
        ]);
        ...
        // Assert that the adable (Commercial office) was updated correctly
        $adable = $ad->adable;
        ...
        $this->assertDatabaseCount('commercial_offices', 1);
    }
}
