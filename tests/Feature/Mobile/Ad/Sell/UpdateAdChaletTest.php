...
class UpdateAdChaletTest extends TestCase
{
    use RefreshDatabase;

    /** @test */
    public function it_updates_a_chalet_ad_successfully()
    {
        ...
        $this->assertDatabaseCount('chalets', 1);
    }
}
