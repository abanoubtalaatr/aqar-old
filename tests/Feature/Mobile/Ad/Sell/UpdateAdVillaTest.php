...
class UpdateAdVillaTest extends TestCase
{
    use RefreshDatabase;
    /** @test */
    /** @test */
    public function it_updates_a_villa_ad_successfully()
    {
        // Create a user and log them in
        $user = User::factory()->create();
        $token = auth('api')->login($user);

        // Create a category for "Vilaa"
        ...
        $updatedData = [
            ...
            'description' => 'Spacious villa for rent',
            'water_supply' => true,
