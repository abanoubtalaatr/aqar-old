...
class UpdateFurnishedApartmentTest extends TestCase
{
    use RefreshDatabase;


    /** @test */
    public function it_update_rent_ad_furnished_apartment_by_month_or_day_successfully()
    {
        ...
        $category = Category::factory()->create([
            'id' => 16,
            'adable' => "App\Models\FurnishedApartment",
        ]);
        ...
        $this->assertDatabaseCount('furnished_apartments', 1);
    }
}
