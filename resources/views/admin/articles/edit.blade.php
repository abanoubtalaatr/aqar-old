@extends('admin.app')
@section('title', __('dashboard.Edit Article'))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-transparent d-flex justify-content-between align-items-center">
                    <h3 class="card-title m-0">@lang('dashboard.Edit Article')</h3>
                    ...
                    <form action="{{ route('admin.articles.update', $article->id) }}" method="POST" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description_ar" name="description_ar" class="form-control" rows="5" required>
                                {{ old('description_ar', $article->description_ar) }}
                            </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2">
                                <img id="imagePreview" 
                                     ...
                                     alt="Article Image" style="max-width: 200px; display: {{ $article->image ? 'block' : 'none' }};">
                            </div>
                            @error('image')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select name="is_active" id="is_active" class="form-control" required>
                                <option value="1" {{ old('is_active', $article->is_active) == 1 ? 'selected' : '' }}>
                                    @lang('dashboard.Active')
                                </option>
                                <option value="0" {{ old('is_active', $article->is_active) == 0 ? 'selected' : '' }}>
