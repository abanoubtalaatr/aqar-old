@extends('admin.app')
@section('title', __('dashboard.Add Admin'))
            ...
            <div class="card">
                <div class="card-header border-transparent">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.admins.index') }}" class="btn btn-tool btn-sm btn-info"
                ...
                <div class="card-body p-0">
                    <form  method="post" action="{{ route('admin.admins.store') }}" id="frm1"
